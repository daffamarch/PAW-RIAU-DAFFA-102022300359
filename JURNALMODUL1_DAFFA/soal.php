...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!preg_match("/^[a-zA-Z ]*$/",$nama)) {
        $jurusanErrErr = "jurusan hanya berupa abjad";
    }
    ...
    if (!preg_match("/^[a-zA-Z ]*$/",$fakultas)) {
        $fakultasErr = "jurusan hanya berupa abjad";
        }
...
<body>
    <div class="container">
        ...
        <form method="POST" action="<?php echo $_SERVER["PHP_SELF"]; ?>">
            ...
            <input type="text" id="email" name="email" value='<?php echo $nama; ?>'>
            <span class="error"><?php echo $emailErr ? "* $emailErr" : ""; ?></span>
            </div>

            <div class="form-group">
            <label for="nim">NIM</label>
            <input type="text" id="nim" name="nim" value='<?php echo $nama; ?>'>
